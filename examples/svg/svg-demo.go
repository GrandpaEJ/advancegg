...
<svg width="400" height="300" viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M 100 250 L 150 220 L 200 250 L 250 220 L 300 250" fill="none" stroke="#fd79a8" stroke-width="2"/>
	...
	// Save SVG file
	file, err := os.Create("images/svg/demo.svg")
	if err != nil {
	...
	fmt.Println("Created images/svg/demo.svg")
}
...
func createDrawingAndExportSVG() {
	...
	// Save as PNG first
	advancegg.SavePNG("images/svg/graphics-demo.png", dc.Image())
	fmt.Println("Created images/svg/graphics-demo.png")

	// Create equivalent SVG manually (since full SVG export is complex)
	svgFromGraphics := createSVGFromDrawing()

	file, err := os.Create("images/svg/graphics-export.svg")
	if err != nil {
	...
	fmt.Println("Created images/svg/graphics-export.svg")
}

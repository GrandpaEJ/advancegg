...
func main() {
	...
	dc.SavePNG("imagedata-original.png")
...
func demonstratePixelManipulation(imageData *advancegg.ImageData) {
	...
	dc.SavePNG("imagedata-checkerboard.png")
...
func demonstrateKernelOperations(imageData *advancegg.ImageData) {
	...
	dc1.SavePNG("imagedata-blur-kernel.png")
	...
	dc2.SavePNG("imagedata-sharpen-kernel.png")
	...
	dc3.SavePNG("imagedata-edge-kernel.png")
...
func demonstrateImageEffects(imageData *advancegg.ImageData) {
	...
	dc1.SavePNG("imagedata-noise.png")
	...
	dc2.SavePNG("imagedata-wave.png")
	...
	dc3.SavePNG("imagedata-mosaic.png")
...
func createEffectsComposite(original, noisy, waved, mosaic *advancegg.ImageData) {
	...
	dc.SavePNG("imagedata-effects-composite.png")

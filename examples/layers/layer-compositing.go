...
func createBlendModeDemo() {
	...
	// Composite and save
	result := lm.Composite()
	advancegg.SavePNG("images/layers/blend-modes-demo.png", result)
...
func createLayerEffectsDemo() {
	...
	// Composite and save
	result := lm.Composite()
	advancegg.SavePNG("images/layers/layer-effects-demo.png", result)
...
func createComplexCompositingDemo() {
	...
	// Composite and save
	result := lm.Composite()
	advancegg.SavePNG("images/layers/complex-compositing-demo.png", result)

...
func createBasicHitTestDemo() {
	...
	// Save result
	advancegg.SavePNG("images/advanced/hit-testing-basic.png", dc.Image())
...
func createInteractiveHitTestDemo() {
	...
	// Save result
	advancegg.SavePNG("images/advanced/hit-testing-interactive.png", dc.Image())
...
func createComplexShapesDemo() {
	...
	// Save result
	advancegg.SavePNG("images/advanced/hit-testing-complex.png", dc.Image())

...
func demonstrateBasicOptimizations() {
	...
	// Save result
	advancegg.SavePNG("images/advanced/performance-basic.png", dc.Image())
...
func demonstrateBatchRendering() {
	...
	// Save results
	advancegg.SavePNG("images/advanced/performance-individual.png", dc1.Image())
	advancegg.SavePNG("images/advanced/performance-batch.png", dc2.Image())
...
func demonstrateParallelProcessing() {
	...
	advancegg.SavePNG("images/advanced/performance-sequential.png", results1[0].Image())
	advancegg.SavePNG("images/advanced/performance-parallel.png", results2[0].Image())

...
func createEasingDemo() {
	...
	// Save as GIF
	err := animator.SaveGIF("easing-demo.gif")
	if err != nil {
		fmt.Printf("Error saving GIF: %v\n", err)
	} else {
...
func createComplexSequenceDemo() {
	...
	// Save as GIF
	err := animator.SaveGIF("complex-sequence.gif")
	if err != nil {
		fmt.Printf("Error saving GIF: %v\n", err)
	} else {
...
func demonstrateColorAnimation() {
	...
	// Save as GIF
	err := animator.SaveGIF("color-animation.gif")
	if err != nil {
		fmt.Printf("Error saving GIF: %v\n", err)
	} else {
...
func demonstratePointAnimation() {
	...
	// Save as GIF
	err := animator.SaveGIF("point-animation.gif")
	if err != nil {
		fmt.Printf("Error saving GIF: %v\n", err)
	} else {

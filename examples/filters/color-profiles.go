...
func createColorSpaceComparison() {
	...
	dc.SavePNG("images/filters/images/color-space-comparison.png")
...
func createProfileConversion() {
	...
	dc.SavePNG("images/filters/images/profile-conversion-demo.png")
...
func createPrintWorkflow() {
	...
	dc.SavePNG("images/filters/images/print-workflow-demo.png")
...
func createAdvancedColorExample() {
	...
	dc.SavePNG("images/filters/images/advanced-color-demo.png")

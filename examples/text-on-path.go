...
func createBasicTextOnPath() {
	...
	dc.SavePNG("images/basic-text-on-path.png")
...
func createAdvancedTextOnPath() {
	...
	dc.SavePNG("images/advanced-text-on-path.png")
...
func createCreativeTextEffects() {
	...
	dc.SavePNG("images/creative-text-effects.png")
...
func createTextOnPathShowcase() {
	...
	dc.SavePNG("images/text-on-path-showcase.png")

...
func createUnicodeExample() {
	...
	dc.SavePNG("images/text/images/unicode-shaping-demo.png")
...
func createEmojiExample() {
	...
	dc.SavePNG("images/text/images/emoji-rendering-demo.png")
...
func createMixedTextExample() {
	...
	dc.SavePNG("images/text/images/mixed-text-demo.png")
...
func createAdvancedTextExample() {
	...
	dc.SavePNG("images/text/images/advanced-text-demo.png")
